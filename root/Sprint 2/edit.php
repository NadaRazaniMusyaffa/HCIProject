				...
				<form>
					<table class="table table-bordered border-dark mt-2 text-center" >
						...
						<tr >
							...
							<td>
								<input type="text" name="nama" id="nama" style="height: 30px;" value="B">
							</td>
							<td>
								<input type="text" name="harga" id="harga" style="height: 30px;" value="Rp 10.000">
							</td>
							<td>
								<input type="text" name="stok" id="stok" style="height: 30px;" value="100">
							</td>
							<td>
								<button type="submit" name="submit" class="btn btn-dark">
									<a href="category.php" class="text-white text-decoration-none">Simpan</a>
								</button>
