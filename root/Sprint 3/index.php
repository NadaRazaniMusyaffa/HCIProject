						...
						<div class="row" >
							<div class="col mt-2" >
								<button class="btn btn-dark category ">
									<a href="pakaian.php" class="text-white text-decoration-none text-center">Pakaian <br><img class="img-fluid" src="pakaian.jpg"></a>
									<p>Icon made by Freepik from www.flaticon.com</p>
								</button>
							</div>
							<div class="col mt-2 mx-auto" >
								<button class="btn btn-dark category"  >
									<a href="sepatu.php" class="text-white text-decoration-none text-center">Sepatu<br><img class="img-fluid" src="sepatu.jpg"></a>
									<p>Icon made by Freepik from www.flaticon.com</p>
								</button>
							</div>
						</div>
				...
				<div class="row mt-4 text-center" >
					<div class="col">
						<div class="row" >
							<div class="col mt-2" >
								<button class="btn btn-dark category " >
									<a href="tas.php" class="text-white text-decoration-none text-center">Tas<br><img class="img-fluid" src="tas.jpg"></a>
									<p>Icon made by Freepik from www.flaticon.com</p>
								</button>
							</div>
							<div class="col mt-2 mx-auto" >
								<button class="btn btn-dark category"  >
									<a href="aksesoris.php" class="text-white text-decoration-none text-center">Aksesoris<br><img class="img-fluid" src="aksesoris.jpg"></a>
				...
				<div class="row mt-4 text-center mb-5" >
					<div class="col">
						<div class="row" >
							<div class="col mt-2" >
								<button class="btn btn-dark category " >
									<a href="sport.php" class="text-white text-decoration-none text-center">Sport<br><img class="img-fluid" src="sport.jpg"></a>
